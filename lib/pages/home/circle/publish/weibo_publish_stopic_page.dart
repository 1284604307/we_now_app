...
import 'package:flutter_app2/services/model/WeiBoTopic.dart';
import 'dart:math';
import "package:dio/dio.dart";

import 'WeiBoTopicType.dart';
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border(
                      left: BorderSide(
                          width: 5,
                          color:
                          _selectCount == index ?  Color(0xffF79A03): Color(0xffEEEDF1)),
                    ),
                  ),
                  alignment: Alignment.center,
                  child: Text(mLeftTopicTypeList[index].name,
                    style: TextStyle(
                        fontSize: 14
                    ),
                  ),
                        ...
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: NetworkImage('${mRightTopicList[index].topicimg}'),
                                      fit: BoxFit.cover
                                  )
                              )
                          ),
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Text("#"+mRightTopicList[index].topicdesc+"#",
                                style: TextStyle(
                                    fontSize: 15
                                        ,color: Colors.black
                                ),
                              ),
                              Text("讨论"+mRightTopicList[index].topicdiscuss+"万",
                                style: TextStyle(
