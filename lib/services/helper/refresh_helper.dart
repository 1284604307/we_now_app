...
import 'package:flutter_app2/pages/wights/activity_indicator.dart';
import 'package:flutter_app2/pages/wights/home_second_floor_page.dart';
...
class HomeRefreshHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ClassicHeader(
      canTwoLevelText: "再次刷新",//S.of(context).refreshTwoLevel,
