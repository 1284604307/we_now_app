...
class ViewStateErrorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String defaultTextData = "重试";//S.of(context).viewStateButtonRetry;
    switch (error.errorType) {
      case ViewStateErrorType.networkTimeOutError:
        ...
        defaultTitle = "加载失败，请检查网络;";//S.of(context).viewStateMessageNetworkError;
      ...
      case ViewStateErrorType.defaultError:
        ...
        defaultTitle = "加载失败";//S.of(context).viewStateMessageError;
        break;
...
class ViewStateButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlineButton(
      child: child ??
          Text(
            "重新加载",//textData ?? S.of(context).viewStateButtonRetry,
